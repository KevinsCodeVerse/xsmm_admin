  ...
  <div class="container">
    ...
    >
      ...
      >
        ...
        <el-form-item
          prop="updateTodayDocument"
          label-width="170px"
          label="仅限修改当天的收支数据:"
        >
          <el-switch v-model="formData.updateTodayDocument"> </el-switch>
        </el-form-item>
    ...
    submitForm() {
      this.$refs.Form.validate(valid => {
        if (valid) {
          ...
          // 在这里对接收到的英文字段进行处理
          console.log(filteredEnglishFields);
          if (this.formData.id) {
            this.$request.post({
              ...
              params: {
                ...
                updateTodayDocument: this.formData.updateTodayDocument
              },
              success: res => {
