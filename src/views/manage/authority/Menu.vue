<template>
  <div id="authority_menu">
      ...
      <div style="width: 620px;">
        ...
        <div class="tools">
          ...
          <el-tooltip
            ...
            placement="right"
          >
            <span class="theme font_size14 pointer" style="margin-left: 15px;"
              >排序<i class="el-icon-question" style="margin-left: 2px;"></i
            ></span>
          </el-tooltip>
          <div>
          ...
          <div class="custom-tree-node" slot-scope="{ node, data }">
            ...
            <span class="operation">
              <el-button
                type="text"
                size="mini"
                @click="() => openMenuForm(data)"
                v-if="data.flag != 2 && isShowOperation"
                >添加</el-button
              >
              <el-button
                type="text"
    ...
    >
      ...
      >
        ...
        <el-form-item label="类型：" prop="flag">
          <el-radio-group v-model="formData.flag">
            <el-radio label="1" v-if="formData.parentFlag == 1"
              >菜单栏</el-radio
            >
            <el-radio
              label="-1"
              v-if="formData.parentFlag == 1 && formData.parentId != -1"
              >普通页面</el-radio
            >
        ...
        <el-form-item
          :label="formData.flag != 2 ? '菜单名称：' : '接口名称：'"
          prop="menuName"
        >
          <el-input
        ...
        <el-form-item
          :label="formData.flag != 2 ? '菜单路由：' : '接口路径：'"
          prop="requestUrl"
        ...
        >
          <el-input
            ...
            :placeholder="
              formData.flag != 2 ? '请输入菜单路由：' : '请输入接口路径：'
            "
          ></el-input>
        </el-form-item>
        <el-form-item
          label="组件路径："
          prop="component"
          v-if="formData.flag != 2 && formData.parentId != -1"
        >
          <el-input
        ...
        <el-form-item
          label="菜单图标："
          prop="menuIcon"
          v-if="formData.flag == 1 && formData.parentId == -1"
        >
          <el-input
            placeholder="请输入图标icon名称"
      ...
      <span slot="footer">
        <el-button @click="menuVisible = false" :disabled="addLoad"
          >取 消</el-button
        >
        <el-button type="primary" @click="add" :loading="addLoad"
          >确 定</el-button
        >
      </span>
    </el-dialog>
    ...
    >
      ...
      >
        <el-form-item label="类型：" prop="flag" v-if="isShowOperation">
          <el-radio-group v-model="formData.flag">
            ...
            <el-radio label="-1" v-if="formData.parentId != -1"
              >普通页面</el-radio
            >
            <el-radio label="2" v-if="formData.parentId != -1">接口</el-radio>
          </el-radio-group>
        ...
        <el-form-item
          :label="formData.flag != 2 ? '页面路由：' : '接口路径：'"
          prop="requestUrl"
        ...
        >
          <el-input
            v-model="formData.requestUrl"
            :placeholder="
              formData.flag != 2 ? '请输入页面路由：' : '请输入接口路径：'
            "
          ></el-input>
        </el-form-item>
        <el-form-item
          ...
          prop="component"
          v-if="
            isShowOperation && formData.flag != 2 && formData.parentId != -1
          "
        >
          <el-input
            v-model="formData.component"
        ...
        <el-form-item
          ...
          prop="menuIcon"
          v-if="
            formData.flag == 1 && formData.parentId == -1 && isShowOperation
          "
        >
          <el-input
            placeholder="请输入图标icon名称"
      ...
      <span slot="footer">
        <el-button @click="updateVisible = false" :disabled="updateLoad"
          >取 消</el-button
        >
        <el-button type="primary" @click="update" :loading="updateLoad"
          >确 定</el-button
        >
      </span>
    </el-dialog>
